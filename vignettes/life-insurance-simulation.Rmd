...
```{r, results = "asis"}
quants <- c(seq(0.70, 0.95, by = 0.05), 0.99)
...
The above table shows our simulations of the first row/insuree in our table of policies.  The values column in the table shows our risk/confidence level for the present value of the death benefit payment.  The above table should appear reasonable for a `r policies$gender[1]` American `r policies$gender[1]` with a `r policies$beath_benefit[1]`.
