...
Simulating one life insurance policy is not that interesting.  The real power of the `insuree` package is to the policiies together for the simulation.  By simulating the group we can come up with confidence levels for the present value of future benefit payments that would otherwise be very difficult to calculate.
