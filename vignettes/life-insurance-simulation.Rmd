...
# use package to define each policy as an Insuree object
hold <- list()
...
out <- lapply(hold, function(k) insuree::rpv_life(k, n = n, interest = rate)$pv)
